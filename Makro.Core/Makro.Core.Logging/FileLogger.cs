...
namespace MaKro.Core.Logging
{
    public class FileLogger : ILogger
    {
        ...
        private string LogPath
        {
            get
            {
                return Path.GetTempPath() + "\\" + System.AppDomain.CurrentDomain.FriendlyName.Replace("vshost.exe", "").Replace(".","").ToLower() + "_" + TodayDateAsString + ".log";
            }
        }
